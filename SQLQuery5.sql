...
/****** Object:  Table [dbo].[Address]    Script Date: 12/28/2025 7:03:37 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Blogs]    Script Date: 12/28/2025 7:03:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Categories]    Script Date: 12/28/2025 7:03:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Comments]    Script Date: 12/28/2025 7:03:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Contacts]    Script Date: 12/28/2025 7:03:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Discount]    Script Date: 12/28/2025 7:03:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Employees]    Script Date: 12/28/2025 7:03:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Favorites]    Script Date: 12/28/2025 7:03:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[InformationShop]    Script Date: 12/28/2025 7:03:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Manufactures]    Script Date: 12/28/2025 7:03:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MenuOne]    Script Date: 12/28/2025 7:03:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MenuTwo]    Script Date: 12/28/2025 7:03:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Orders]    Script Date: 12/28/2025 7:03:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Products]    Script Date: 12/28/2025 7:03:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Roles]    Script Date: 12/28/2025 7:03:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[User_Role]    Script Date: 12/28/2025 7:03:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Users]    Script Date: 12/28/2025 7:03:37 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
INSERT [dbo].[Blogs] ([Id], [Title], [Content], [Logo], [UploadDay], [Banner], [Active], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate], [NameSearch], [Description]) VALUES (3, N'Review sách: Hoa Tulip đen – Alexandre Dumas', N'<h3>Review sách: Hoa Tulip đen – Alexandre Dumas</h3>
                                ...
                                </span>', N'hoa-tulip-den-logo.png', CAST(N'2025-12-11' AS Date), N'hoa-tulip-den-banner.png', 1, CAST(N'2025-12-11T07:33:37.560' AS DateTime), 3, NULL, 0, NULL, 0, N'hoa-tuli-den', N'Lối viết của Dumas Cha là lối bút duy trì sự kết hợp hoàn hảo giữa chân lý hiện thực và những phép màu kì diệu nhân đạo hóa mỗi câu chuyện, mỗi linh hồn trong tiểu thuyết. Văn phong nhà văn chỉ ra rằng, dù là trong tâm tưởng của kẻ viết lách hay')
...
INSERT [dbo].[Blogs] ([Id], [Title], [Content], [Logo], [UploadDay], [Banner], [Active], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate], [NameSearch], [Description]) VALUES (7, N'Đám cưới không có giấy giá thú: Bi kịch của tri thức', N'<h3>Đám cưới không có giấy giá thú: Bi kịch của tri thức</h3>
                                ...
                                <span>
                                    ...
                                    ngầm.”
                                </span>', N'dam-cuoi-khong-co-gia-thu-logo.png', CAST(N'2025-12-11' AS Date), N'dam-cuoi-khong-co-gia-thu-banner.png', 1, CAST(N'2025-12-11T16:15:59.487' AS DateTime), 3, NULL, 0, NULL, 0, N'dam-cuoi-khong-co-gia-thu', N'Câu chuyện về một nhà giáo muốn được xã hội công nhận “nên duyên” với khát khao đời mình, nhưng bị cự tuyệt thẳng thừng bởi những kẻ tự xưng là đại diện “họ nhà gái”. Qua những lát cắt về cuộc đời Tự và cả những người xung quanh')
...
INSERT [dbo].[Blogs] ([Id], [Title], [Content], [Logo], [UploadDay], [Banner], [Active], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate], [NameSearch], [Description]) VALUES (9, N'Mùa thu của cây dương: Khi ta mở lòng với thế giới, có biết bao điều từ thế giới ấy chảy vào ta', N'<h3>Mùa thu của cây dương: Khi ta mở lòng với thế giới, có biết bao điều từ thế giới ấy
                                ...
                                </span>', N'mua-thu-cua-cay-duong-logo.png', CAST(N'2025-12-11' AS Date), N'mua-thu-cua-cay-duong-banner.png', 1, CAST(N'2025-12-11T16:50:07.607' AS DateTime), 3, NULL, 0, NULL, 0, N'mua-thu-cua-cay-duong', N'Sau thành công được đón nhận của “Khu vườn mùa hạ”, Kazumi Yumoto tiếp tục mang đến cho người đọc những câu chuyện về trẻ nhỏ và quá trình trưởng thành của chúng. Bằng giọng văn tinh tế')
SET IDENTITY_INSERT [dbo].[Blogs] OFF
GO
SET IDENTITY_INSERT [dbo].[Categories] ON 

INSERT [dbo].[Categories] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate], [NameSearch]) VALUES (2, N'Pháp Lý', N'9-20x20.png', N'banner-3.jpg', N'Sách lược chính trị hay Chiến lược chính trị là đường lối, phương pháp, cách thức của một hệ thống quản trị lớn, thường là một chính phủ, đảng phái chính trị, nhằm đạt được mục tiêu chính trị trong việc quản trị quốc gia, tổ chức.', CAST(N'2025-09-20T19:09:20.993' AS DateTime), 3, NULL, 0, CAST(N'2025-11-12T14:59:21.427' AS DateTime), 1, N'phap-ly')
INSERT [dbo].[Categories] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate], [NameSearch]) VALUES (3, N'Kinh Tế', N'5-20x20.png', N'az-viet-nam-banner.jpg', N'Khoa học công nghệ là cách gọi tắt của cụm từ “khoa học và công nghệ”, trong đó Khoa học là hệ thống tri thức về bản chất, quy luật tồn tại và phát triển của sự vật, hiện tượng tự nhiên, xã hội và tư duy', CAST(N'2025-09-21T20:17:20.360' AS DateTime), 3, NULL, 0, CAST(N'2025-12-20T22:28:24.620' AS DateTime), 3, N'kinh-te')
INSERT [dbo].[Categories] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate], [NameSearch]) VALUES (4, N'Văn Hóa Xã Hội', N'2-20x20.png', N'banner-3.jpg', N'Văn hóa xã hội – Lịch sử', CAST(N'2025-09-21T20:18:06.043' AS DateTime), 3, NULL, 0, CAST(N'2025-10-12T19:56:49.137' AS DateTime), 3, N'van-hoa-xa-hoi')
INSERT [dbo].[Categories] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate], [NameSearch]) VALUES (5, N'Văn Học Nghệ Thuật', N'6-20x20.png', N'banner-3.jpg', N'Sách Văn học nghệ thuật không bao giờ là một tổng cộng các văn bản vô định hình-đồng chất: nó không chỉ là sự tổ chức, mà còn là một cơ chế tự tổ chức. Trên trình độ cao hơn về tổ chức văn học, nó phân xuất ra một nhóm văn bản trừu tượng hơn so với cái khối văn bản còn lại, cái cấp độ, tức là các siêu văn bản.', CAST(N'2025-09-21T20:19:40.737' AS DateTime), 3, NULL, 0, CAST(N'2025-10-12T19:57:36.573' AS DateTime), 3, N'van-hoc-nghe-thuat')
INSERT [dbo].[Categories] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate], [NameSearch]) VALUES (6, N'Giáo Trình', N'11-20x20.png', N'banner-3.jpg', N'Giáo trình là hệ thống chương trình giảng dạy của một môn học. Nó là tài liệu học tập hoặc giảng dạy được thiết kế và biên soạn dựa trên cơ sở chương trình môn học. Mục đích để làm tài liệu giảng dạy chính thức cho giáo viên, hoặc / và làm tài liệu học tập chính thức cho học sinh, sinh viên.', CAST(N'2025-09-21T20:22:23.947' AS DateTime), 3, NULL, 0, CAST(N'2025-10-12T19:57:48.607' AS DateTime), 3, N'giao-trinh')
INSERT [dbo].[Categories] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate], [NameSearch]) VALUES (7, N'Light Novel', N'4-20x20.png', N'alpha-book-banner.jpg', N'Tiểu thuyết là một thể loại văn xuôi có hư cấu, thông qua nhân vật, hoàn cảnh, sự việc để phản ánh bức tranh xã hội rộng lớn và những vấn đề của cuộc sống con người, biểu hiện tính chất tường thuật, tính chất kể chuyện bằng ngôn ngữ văn xuôi theo những chủ đề xác định.', CAST(N'2025-09-21T20:24:22.287' AS DateTime), 3, NULL, 0, CAST(N'2025-12-20T22:27:04.633' AS DateTime), 3, N'light-novel')
INSERT [dbo].[Categories] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate], [NameSearch]) VALUES (8, N'Tâm Linh', N'10-20x20.png', N'banner-3.jpg', N'Sách tâm lý học được hiểu là những cuốn sách nghiên cứu, phân tích về các hiện tượng tâm lý hoặc tinh thần nảy sinh trong não người. Đây cũng được xem là bộ môn khoa học với quy mô nghiên cứu rộng rãi, đa dạng.', CAST(N'2025-09-22T06:02:54.557' AS DateTime), 3, NULL, 0, CAST(N'2025-09-22T10:01:44.787' AS DateTime), 3, N'tam-linh')
INSERT [dbo].[Categories] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate], [NameSearch]) VALUES (9, N'Thiếu Nhi', N'10-20x20.png', N'nxb-kim-dong-banner.jpg', N'Một nhà văn viết về văn học thiếu nhi định nghĩa nó là "tất cả các cuốn sách viết cho trẻ em, ngoại trừ các tác phẩm như truyện tranh, truyện cười, sách hoạt hình và các tác phẩm phi hư cấu không được đọc từ trước ra sau, như từ điển, bách khoa toàn thư và các tài liệu tham khảo khác."', CAST(N'2025-09-22T06:03:43.933' AS DateTime), 3, NULL, 0, CAST(N'2025-12-20T22:27:50.997' AS DateTime), 3, N'thieu-nhi')
SET IDENTITY_INSERT [dbo].[Categories] OFF
GO
SET IDENTITY_INSERT [dbo].[Comments] ON 

INSERT [dbo].[Comments] ([Id], [Content], [Star], [User_Id], [Product_Id], [Date], [Status]) VALUES (1, N'sád', 5, 1, 14, CAST(N'2025-11-25' AS Date), N'1')
INSERT [dbo].[Comments] ([Id], [Content], [Star], [User_Id], [Product_Id], [Date], [Status]) VALUES (2, N'vAlnecuong', 5, 3, 15, CAST(N'2025-12-04' AS Date), N'1')
INSERT [dbo].[Comments] ([Id], [Content], [Star], [User_Id], [Product_Id], [Date], [Status]) VALUES (3, N'ádhakshdkajshdkj', 3, 3, 15, CAST(N'2025-12-04' AS Date), N'1')
INSERT [dbo].[Comments] ([Id], [Content], [Star], [User_Id], [Product_Id], [Date], [Status]) VALUES (4, N'Sách hay', 4, 2, 34, CAST(N'2025-12-21' AS Date), N'1')
INSERT [dbo].[Comments] ([Id], [Content], [Star], [User_Id], [Product_Id], [Date], [Status]) VALUES (5, N'sản phẩm tốt giá tốt giao hàng nhanh lần sau sẽ ủng hộ shop tiếp', 5, 2, 34, CAST(N'2025-12-21' AS Date), N'0')
INSERT [dbo].[Comments] ([Id], [Content], [Star], [User_Id], [Product_Id], [Date], [Status]) VALUES (6, N'Sách vẫn còn seal, có bonus như miêu tả, mà do lá thư màu mực đậm quá nên màu xanh của thư in hẳn lên sách tạo thàng 1 đường màu khá đặc biệt :(((', 4, 2, 34, CAST(N'2025-12-21' AS Date), N'1')
...
', 5, 2, 34, CAST(N'2025-12-21' AS Date), N'0')
INSERT [dbo].[Comments] ([Id], [Content], [Star], [User_Id], [Product_Id], [Date], [Status]) VALUES (8, N'Rất tốt, không bị đình trệ, mong là nội dung sẽ không làm mình thất vọng.', 4, 1, 34, CAST(N'2025-12-21' AS Date), N'0')
INSERT [dbo].[Comments] ([Id], [Content], [Star], [User_Id], [Product_Id], [Date], [Status]) VALUES (9, N'Truyện đẹp lắm, đầy đủ ct nma chỗ lá thư bị tróc :((', 4, 1, 34, CAST(N'2025-12-21' AS Date), N'1')
INSERT [dbo].[Comments] ([Id], [Content], [Star], [User_Id], [Product_Id], [Date], [Status]) VALUES (10, N'Hàng rất rất là đẹp gói hàng chắc chắn giao nhanh sp chất lượng', 4, 1, 34, CAST(N'2025-12-21' AS Date), N'1')
INSERT [dbo].[Comments] ([Id], [Content], [Star], [User_Id], [Product_Id], [Date], [Status]) VALUES (11, N'Hàng đẹp, gói hàng cũng đc, nhiều quà, giá khá là rẻ :)))))))))', 5, 1, 34, CAST(N'2025-12-21' AS Date), N'1')
INSERT [dbo].[Comments] ([Id], [Content], [Star], [User_Id], [Product_Id], [Date], [Status]) VALUES (12, N'demo', 4, 3, 37, CAST(N'2025-12-21' AS Date), N'1')
...
INSERT [dbo].[Discount] ([Id], [Name], [Code], [Price], [Quality], [ApplyDay], [Expiration], [MoneyLimit], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (16, N'Giảm giá 30.000đ cho đơn hàng trên 150.000đ', N'GSVV202512', 30000, 5, CAST(N'2024-12-17' AS Date), CAST(N'2025-12-23' AS Date), 150000, CAST(N'2025-12-17T15:22:14.587' AS DateTime), 3, NULL, 0, NULL, 0)
...
INSERT [dbo].[Manufactures] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (1, N'NXB Kim Đồng', N'nxb-kim-dong.png', N'nxb-kim-dong-banner.jpg', N'Nhà xuất bản Kim Đồng trực thuộc Trung ương Đoàn TNCS Hồ Chí Minh là Nhà xuất bản tổng hợp có chức năng xuất bản sách và văn hóa phẩm phục vụ thiếu nhi và các bậc phụ huynh trong cả nước, quảng bá và giới thiệu văn hóa Việt Nam ra thế giới. Nhà xuất bản có nhiệm vụ tổ chức bản thảo, biên soạn, biên dịch, xuất bản và phát hành các xuất bản phẩm có nội dung: giáo dục truyền thống dân tộc, giáo dục về tri thức, kiến thức… trên các lĩnh vực văn học, nghệ thuật, khoa học', CAST(N'2025-09-21T20:08:21.840' AS DateTime), 3, NULL, 0, CAST(N'2025-12-15T07:51:32.643' AS DateTime), 3)
INSERT [dbo].[Manufactures] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (2, N'Thái Hà', N'thai-ha.jpg', N'thai-ha-banner.jpg', N'Thái Hà Books mong muốn mang tri thức trong những cuốn sách ở khắp nơi trên thế giới đến với độc giả Việt Nam. Những cuốn sách có giá trị, có tính ứng dụng và thực tiễn cao của Thái Hà Books sẽ làm cho cuộc sống tươi đẹp hơn, phong phú hơn. Trong tương lai, với xu thế hội nhập toàn cầu, Thái Hà Books mong muốn trở thành con chim đầu đàn đi ra biển lớn.', CAST(N'2025-09-21T20:10:50.670' AS DateTime), 3, NULL, 0, CAST(N'2025-12-15T08:07:02.560' AS DateTime), 3)
INSERT [dbo].[Manufactures] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (3, N'FIRST NEWS', N'first-new.jpg', N'first-new-banner.png', N'Được thành lập vào ngày 10/12/1994 với tên gọi ban đầu là “Ban Biên Dịch First News”, trải qua 25 năm luôn nỗ lực và sáng tạo, đến nay First News – Trí Việt đã khẳng định được vị thế cũng như uy tín của mình trong lòng bạn đọc, không những bởi sự phong phú của những dòng sách giá trị trên thế giới mà First News đã nhạy bén chuyển ngữ phục vụ người Việt Nam, mà còn vì chất lượng cũng như sự chỉn chu trong từng quyển sách mà First News mong muốn mang đến cho bạn đọc.', CAST(N'2025-09-22T05:32:29.543' AS DateTime), 3, NULL, 0, CAST(N'2025-12-15T08:17:43.993' AS DateTime), 3)
INSERT [dbo].[Manufactures] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (4, N'AZ Việt Nam', N'az-viet-nam.jpg', N'az-viet-nam-banner.jpg', N'Khởi nguồn của AZ Việt Nam ngày nay là Công ty TNHH Trung tâm Sách và Thiết bị Thư viện, với hoạt động đầu tiên là cung cấp sách, trang thiết bị, văn hóa phẩm cho các thư viện và trung tâm sách trên cả nước. Từ cuối năm 2010 đến nay, chúng tôi đã không ngừng nỗ lực khai phá và phát triển các dòng sản phẩm mới với 8 thương hiệu uy tín.', CAST(N'2025-09-22T05:35:32.713' AS DateTime), 3, NULL, 0, CAST(N'2025-12-15T06:45:43.560' AS DateTime), 3)
INSERT [dbo].[Manufactures] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (5, N'IPM', N'ipm.jpg', N'ipm-sach-banner.jpg', N'Công ty Cổ phần Xuất bản và Truyền thông IPM được thành lập tháng 02 năm 2004 bới một nhóm sáng lập viên trẻ tuổi, nhiệt tình và năng động và có nhiều năm kinh nghiệm hoạt động trong lĩnh vực xuất bản Việt Nam. Ngay sau khi Việt Nam chính thức tham gia công ước Berne (Công ước quốc tế về bảo hộ các tác phẩm văn học nghệ thuật) vào ngày 24/10/2004, IPM là một trong số ít các công ty Việt Nam đi tiên phong trong việc tìm kiếm, khai thác và mua bản quyền sách nước ngoài.', CAST(N'2025-09-22T05:36:28.887' AS DateTime), 3, NULL, 0, CAST(N'2025-12-15T06:50:37.163' AS DateTime), 3)
INSERT [dbo].[Manufactures] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (6, N'Amak Books', N'amak-book.png', N'amak-book-banner.png', N'Amak Books, hiện đã trở thành một nhãn sách độc lập thuộc về công ty X.Y.Z. Chúng tôi tự hào là một trong những người tiên phong thương hiệu trong lĩnh vực chính sách bản quyền tại Việt Nam. Qua nhiều năm, với những nỗ lực và sự đóng góp của đội ngũ nhân viên của chúng tôi, sự năng động và nhiệt tình của các cộng tác viên, AMAK BOOKS đã trở thành một thương hiệu sách đáng tin cậy với danh tiếng tốt cho tất cả các đối tác bên trong và ngoài nước.', CAST(N'2025-09-22T05:59:01.767' AS DateTime), 3, NULL, 0, CAST(N'2025-12-15T07:42:34.460' AS DateTime), 3)
INSERT [dbo].[Manufactures] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (7, N'NXB Trẻ', N'nxb-tre.jpg', N'nxb-tre-banner.jpg', N'Sau gần năm năm hoạt động với nhiều nỗ lực và hiệu quả, ngày 3-2-1986, NXB Măng Non được UBND TP.HCM ký quyết định đổi tên thành NXB Trẻ với chức năng và nhiệm vụ được mở rộng là đơn vị xuất bản dành cho thanh thiếu nhi thành phố và khu vực Nam bộ.', CAST(N'2025-09-22T05:59:54.977' AS DateTime), 3, NULL, 0, CAST(N'2025-12-15T08:12:56.803' AS DateTime), 3)
INSERT [dbo].[Manufactures] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (8, N'Alpha Books', N'alpha-book.png', N'alpha-book-banner.jpg', N'Công ty cổ phần Sách Alpha (Alpha Books Joint-Stock Company – gọi tắt là Alpha Books) do một nhóm trí thức trẻ thành lập ở Hà Nội năm 2005 với niềm tin: Tri thức là Sức mạnh. Thông qua việc giới thiệu các tác phẩm có giá trị của thế giới, Alpha Books mong muốn trở thành nhịp cầu nối nguồn tri thức nhân loại với dân tộc Việt Nam.', CAST(N'2025-09-22T06:01:33.803' AS DateTime), 3, NULL, 0, CAST(N'2025-12-15T07:56:15.557' AS DateTime), 3)
INSERT [dbo].[Manufactures] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (9, N'SkyBooks', N'sky-book.png', N'sky-book-banner.jpg', N'Thương hiệu sách Skybooks là địa chỉ tin cậy cho các tác giả trẻ Việt Nam gửi gắm tác phẩm của mình. Với khẩu hiệu “Tôi trẻ, tôi đam mê”, chúng tôi luôn nỗ lực để mang đến cho độc giả những tác phẩm chất lượng từ các tác giả trẻ nổi bật cũng như giúp đỡ, tạo điều kiện cho các cây bút trẻ được đông đảo độc giả biết đến. Hãy để Skybooks trở thành người đưa đứa con tinh thần của bạn đến với công chúng!', CAST(N'2025-12-15T07:08:51.860' AS DateTime), 3, NULL, 0, NULL, 0)
INSERT [dbo].[Manufactures] ([Id], [Name], [Logo], [Banner], [Description], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (10, N'Nhã Nam', N'nha-nam.jpg', N'nha-nam-banner.png', N'Tháng 2 năm 2005, Nhã Nam, tên đầy đủ là Công ty Cổ phần Văn hóa và Truyền thông Nhã Nam đã gia nhập thị trường sách. Tác phẩm "Balzac và cô bé thợ may Trung hoa" của Đới Tư Kiệt là cuốn sách đầu tiên được những người sáng lập Nhã Nam xuất bản cả trước khi công ty ra đời. Ngay lập tức từ cuốn sách đầu tiên, độc giả đã dành sự quan tâm và yêu mến cho một thương hiệu sách mới mẻ mang trong mình khát vọng góp phần tạo lập diện mạo mới cho xuất bản văn học tại Việt Nam.', CAST(N'2025-12-15T07:29:29.313' AS DateTime), 3, NULL, 0, NULL, 0)
SET IDENTITY_INSERT [dbo].[Manufactures] OFF
GO
SET IDENTITY_INSERT [dbo].[MenuOne] ON 

INSERT [dbo].[MenuOne] ([Id], [Name], [NameSearch], [Cate_Id], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (1, N'Ngoại ngữ', N'ngoai-ngu', 6, CAST(N'2025-09-23T14:43:01.383' AS DateTime), 3, NULL, 0, NULL, 0)
INSERT [dbo].[MenuOne] ([Id], [Name], [NameSearch], [Cate_Id], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (2, N'Chính trị', N'chinh-tri', 2, CAST(N'2025-09-23T16:02:58.560' AS DateTime), 3, NULL, 0, CAST(N'2025-09-23T16:34:20.823' AS DateTime), 3)
INSERT [dbo].[MenuOne] ([Id], [Name], [NameSearch], [Cate_Id], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (3, N'Tài liệu', N'tai-lieu', 6, CAST(N'2025-09-27T13:34:44.253' AS DateTime), 3, NULL, 0, NULL, 0)
INSERT [dbo].[MenuOne] ([Id], [Name], [NameSearch], [Cate_Id], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (4, N'Pháp Luật', N'phap-luat', 2, CAST(N'2025-09-27T13:36:23.300' AS DateTime), 3, NULL, 0, NULL, 0)
INSERT [dbo].[MenuOne] ([Id], [Name], [NameSearch], [Cate_Id], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (5, N'Quản Trị - Lãnh Đạo', N'quan-tri-lanh-dao', 3, CAST(N'2025-09-27T13:48:34.030' AS DateTime), 3, NULL, 0, NULL, 0)
INSERT [dbo].[MenuOne] ([Id], [Name], [NameSearch], [Cate_Id], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (6, N'Marketing - Bán Hàng', N'marketing-ban-hang', 3, CAST(N'2025-09-27T13:49:03.473' AS DateTime), 3, NULL, 0, NULL, 0)
INSERT [dbo].[MenuOne] ([Id], [Name], [NameSearch], [Cate_Id], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (7, N'Phân tích kinh tế', N'phan-tich-kinh-te', 3, CAST(N'2025-11-25T10:24:17.207' AS DateTime), 1, NULL, 0, NULL, 0)
SET IDENTITY_INSERT [dbo].[MenuOne] OFF
GO
SET IDENTITY_INSERT [dbo].[MenuTwo] ON 

INSERT [dbo].[MenuTwo] ([Id], [Name], [NameSearch], [Menu1_Id], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (1, N'Tiếng Anh', N'tieng-anh', 1, CAST(N'2025-09-27T08:57:16.547' AS DateTime), 3, NULL, 0, CAST(N'2025-09-27T09:50:05.843' AS DateTime), 3)
INSERT [dbo].[MenuTwo] ([Id], [Name], [NameSearch], [Menu1_Id], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (2, N'Tiếng Trung', N'tieng-trung', 1, CAST(N'2025-09-27T13:51:41.380' AS DateTime), 3, NULL, 0, NULL, 0)
INSERT [dbo].[MenuTwo] ([Id], [Name], [NameSearch], [Menu1_Id], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (3, N'Tiếng Hàn', N'tieng-han', 1, CAST(N'2025-09-27T13:51:57.833' AS DateTime), 3, NULL, 0, CAST(N'2025-11-25T10:24:57.327' AS DateTime), 1)
INSERT [dbo].[MenuTwo] ([Id], [Name], [NameSearch], [Menu1_Id], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (4, N'Tiếng Nhật', N'tieng-nhat', 1, CAST(N'2025-09-27T13:52:57.890' AS DateTime), 3, NULL, 0, NULL, 0)
INSERT [dbo].[MenuTwo] ([Id], [Name], [NameSearch], [Menu1_Id], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (6, N'Nguồn gốc vật chất', N'nguon-goc-vat-chat', 2, CAST(N'2025-09-27T13:53:49.330' AS DateTime), 3, NULL, 0, CAST(N'2025-11-25T10:21:40.650' AS DateTime), 1)
INSERT [dbo].[MenuTwo] ([Id], [Name], [NameSearch], [Menu1_Id], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (7, N'Khoa học chính trị', N'khoa-hoc-chinh-tri', 2, CAST(N'2025-09-27T13:54:08.687' AS DateTime), 3, NULL, 0, NULL, 0)
INSERT [dbo].[MenuTwo] ([Id], [Name], [NameSearch], [Menu1_Id], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (8, N'Xã hội chính trị', N'xa--hoi-chinh-tri', 2, CAST(N'2025-09-27T13:54:29.927' AS DateTime), 3, NULL, 0, NULL, 0)
INSERT [dbo].[MenuTwo] ([Id], [Name], [NameSearch], [Menu1_Id], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (9, N'Chức năng quản trị', N'chuc-nang-quan-tri', 5, CAST(N'2025-09-27T13:55:09.010' AS DateTime), 3, NULL, 0, NULL, 0)
INSERT [dbo].[MenuTwo] ([Id], [Name], [NameSearch], [Menu1_Id], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (10, N'Vai trò quản trị', N'vai-tro-quan-tri', 5, CAST(N'2025-09-27T13:55:41.077' AS DateTime), 3, NULL, 0, NULL, 0)
INSERT [dbo].[MenuTwo] ([Id], [Name], [NameSearch], [Menu1_Id], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate]) VALUES (11, N'Các khía cạnh khác', N'cac-khia-canh-khac', 5, CAST(N'2025-09-27T13:56:11.403' AS DateTime), 3, NULL, 0, NULL, 0)
SET IDENTITY_INSERT [dbo].[MenuTwo] OFF
GO
SET IDENTITY_INSERT [dbo].[Orders] ON 

INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (16, N'565067', 15, 1, NULL, 1, CAST(N'2025-12-07' AS Date), N'1', N'3', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (17, N'179557', 15, 1, NULL, 1, CAST(N'2025-12-08' AS Date), N'1', N'3', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (18, N'345868', 16, 1, NULL, 1, CAST(N'2025-11-08' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (19, N'345868', 21, 1, NULL, 1, CAST(N'2025-11-08' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (20, N'129524', 8, 1, NULL, 2, CAST(N'2025-12-08' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (21, N'990582', 17, 1, NULL, 2, CAST(N'2025-12-08' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (22, N'673447', 18, 1, NULL, 1, CAST(N'2025-12-08' AS Date), N'1', N'3', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (23, N'638499', 23, 1, NULL, 1, CAST(N'2025-12-09' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (24, N'638499', 24, 1, NULL, 1, CAST(N'2025-12-09' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (25, N'638499', 28, 1, NULL, 1, CAST(N'2025-11-09' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (26, N'612596', 25, 1, NULL, 2, CAST(N'2025-12-09' AS Date), N'1', N'3', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (27, N'635789', 22, 1, NULL, 3, CAST(N'2025-12-09' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (28, N'635789', 24, 1, NULL, 3, CAST(N'2025-12-09' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (29, N'635789', 27, 1, NULL, 2, CAST(N'2025-11-09' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (30, N'635789', 15, 1, NULL, 3, CAST(N'2025-12-09' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (31, N'461651', 28, 1, NULL, 1, CAST(N'2025-12-09' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (32, N'662729', 27, 1, NULL, 3, CAST(N'2025-11-09' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (33, N'461519', 15, 1, NULL, 1, CAST(N'2025-12-09' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (34, N'591827', 15, 1, NULL, 2, CAST(N'2025-11-09' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (35, N'890353', 24, 62, NULL, 1, CAST(N'2025-12-09' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (36, N'293583', 24, 1, 4, 1, CAST(N'2025-12-09' AS Date), N'1', N'1', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (37, N'605977', 28, 1, NULL, 1, CAST(N'2025-12-12' AS Date), N'1', N'0', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (38, N'349013', 23, 1, NULL, 1, CAST(N'2025-12-12' AS Date), N'1', N'1', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (39, N'239502', 26, 1, NULL, 2, CAST(N'2025-12-14' AS Date), N'1', N'3', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (40, N'633333', 23, 1, 5, 2, CAST(N'2025-12-15' AS Date), N'1', N'3', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (41, N'406856', 24, 1, 5, 1, CAST(N'2025-12-15' AS Date), N'1', N'3', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (42, N'524566', 28, 1, NULL, 1, CAST(N'2025-12-15' AS Date), N'1', N'3', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (43, N'536819', 28, 1, NULL, 1, CAST(N'2025-11-15' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (44, N'594462', 28, 1, 5, 1, CAST(N'2025-12-15' AS Date), N'1', N'1', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (45, N'896181', 25, 1, NULL, 1, CAST(N'2025-12-15' AS Date), N'1', N'0', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (46, N'245535', 21, 1, NULL, 2, CAST(N'2025-12-15' AS Date), N'1', N'1', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (47, N'507338', 26, 1, NULL, 1, CAST(N'2025-12-15' AS Date), N'1', N'3', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (48, N'571131', 27, 1, NULL, 1, CAST(N'2025-12-15' AS Date), N'1', N'0', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (49, N'974329', 18, 65, NULL, 2, CAST(N'2025-12-16' AS Date), N'0', N'1', N'Đính kèm hóa đơn')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (50, N'974329', 19, 65, NULL, 2, CAST(N'2025-12-16' AS Date), N'0', N'1', N'Đính kèm hóa đơn')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (51, N'231484', 23, 65, NULL, 1, CAST(N'2025-12-16' AS Date), N'1', N'0', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (52, N'402408', 22, 1, 4, 2, CAST(N'2025-12-19' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (53, N'916886', 33, 64, NULL, 1, CAST(N'2025-12-20' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (54, N'205383', 34, 65, NULL, 3, CAST(N'2025-12-20' AS Date), N'0', N'2', N'gửi hóa đơn')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (55, N'731656', 37, 65, NULL, 1, CAST(N'2025-12-20' AS Date), N'1', N'0', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (56, N'731656', 29, 65, NULL, 3, CAST(N'2025-12-20' AS Date), N'1', N'0', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (57, N'731656', 30, 65, NULL, 2, CAST(N'2025-12-20' AS Date), N'1', N'0', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (58, N'624208', 36, 65, NULL, 1, CAST(N'2025-12-20' AS Date), N'1', N'3', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (59, N'955226', 38, 65, NULL, 1, CAST(N'2025-12-20' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (60, N'864440', 17, 65, NULL, 2, CAST(N'2025-12-20' AS Date), N'1', N'3', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (61, N'765106', 39, 1, NULL, 5, CAST(N'2025-12-20' AS Date), N'1', N'1', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (62, N'773692', 32, 1, NULL, 1, CAST(N'2025-12-20' AS Date), N'1', N'0', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (63, N'181649', 21, 65, NULL, 1, CAST(N'2025-12-21' AS Date), N'1', N'1', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (64, N'181649', 23, 65, NULL, 1, CAST(N'2025-11-21' AS Date), N'1', N'1', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (65, N'751787', 35, 65, NULL, 3, CAST(N'2025-12-21' AS Date), N'1', N'1', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (66, N'240847', 22, 65, NULL, 1, CAST(N'2025-12-21' AS Date), N'1', N'3', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (67, N'240847', 26, 65, NULL, 1, CAST(N'2025-12-21' AS Date), N'1', N'3', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (68, N'240847', 15, 65, NULL, 1, CAST(N'2025-12-21' AS Date), N'1', N'3', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (69, N'836370', 23, 63, NULL, 1, CAST(N'2025-12-21' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (70, N'284165', 29, 63, NULL, 2, CAST(N'2025-12-21' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (71, N'853361', 33, 63, NULL, 1, CAST(N'2025-12-21' AS Date), N'1', N'1', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (72, N'736733', 32, 68, NULL, 1, CAST(N'2025-12-21' AS Date), N'0', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (73, N'736733', 30, 68, NULL, 2, CAST(N'2025-12-21' AS Date), N'0', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (74, N'957074', 25, 68, NULL, 4, CAST(N'2025-12-21' AS Date), N'1', N'0', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (75, N'302712', 31, 68, NULL, 2, CAST(N'2025-12-21' AS Date), N'1', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (76, N'277366', 37, 69, 4, 2, CAST(N'2025-12-21' AS Date), N'0', N'2', N'')
INSERT [dbo].[Orders] ([Id], [Code], [Product_Id], [Address_Id], [Discount_Id], [Quality], [Date], [Method], [Status], [Comment]) VALUES (77, N'971854', 40, 1, 17, 1, CAST(N'2025-12-21' AS Date), N'1', N'3', N'')
...
Khác với những câu chuyện cuốn bạn chạy một mạch, truyện này khó mà đọc nhanh. Ngón tay bạn hẳn sẽ ngừng lại cả trăm lần trên mỗi trang sách. Chỉ vì một cử động rất khẽ, một câu thoại, hay một xúc cảm bất chợt có thể sẽ đánh thức những điều tưởng chừng đã ngủ quên trong tiềm thức, như ngọn đèn vừa được bật sáng trong tâm trí bạn. Và rồi có lúc nó vượt quá giới hạn chịu đựng, bạn quyết định gấp cuốn sách lại chỉ để tận hưởng chút ánh sáng từ ngọn đèn, hay đơn giản là để vết thương trong lòng mình có thời gian tự tìm xoa dịu.', N'<table class="table table-bordered">
									...
									</table>', N'5-cm-tren-giay-1.jpg', N'5-cm-tren-giay-2.jpg', N'5-cm-tren-giay-3.jpg', N'5-cm-tren-giay-4.jpg', N'5-cm-tren-giay-5.jpg', 1, 1, 7, N'5-centimet-tren-giay', CAST(N'2025-12-08T06:01:59.943' AS DateTime), 3, NULL, 0, CAST(N'2025-12-12T10:13:23.157' AS DateTime), 3, 40000)
...
Đây là phiên bản tiểu thuyết của bộ phim hoạt hình Your Name., do chính đạo diễn <b>Shinkai Makoto</b> chấp bút.', N'<table class="table table-bordered">
									...
									</table>', N'yourname-1.jpg', N'yourname-2.jpg', N'yourname-3.jpg', N'yourname-4.jpg', N'yourname-5.jpg', 1, 1, 7, N'truyen-your-name', CAST(N'2025-12-08T20:25:30.510' AS DateTime), 3, NULL, 0, CAST(N'2025-12-08T20:30:01.780' AS DateTime), 3, 0)
...
Làm nền cho tất cả là mưa rơi không ngừng, là lá mướt mát rung rinh. Nhưng khi mưa tạnh và trời quang trở lại, mọi đường nét của hiện thực trở nên rõ rệt đến khắc nghiệt, thì những êm dịu và lửng lơ kia liệu còn khả năng tồn tại?', N'<table class="table table-bordered">
									...
									</table>', N'khu-vuon-ngon-tu-1.jpg', N'khu-vuon-ngon-tu-2.jpg', N'khu-vuon-ngon-tu-3.jpg', N'khu-vuon-ngon-tu-4.jpg', N'khu-vuon-ngon-tu-5.jpg', 1, 1, 7, N'khu-vuon-ngon-tu', CAST(N'2025-12-08T20:39:13.457' AS DateTime), 3, NULL, 0, NULL, 0, 0)
...
Tớ mới thấy mọi thứ tỏa sáng lấp lánh…”', N'<table class="table table-bordered">
									...
									</table>', N'binhminh_1.jpg', N'binhminh_2.jpg', N'binhminh_3.jpg', N'binhminh_4.jpg', N'binhminh_5.jpg', 1, 2, 7, N'khi-binh-minh-den-to-muon-gap-cau-dau-tien', CAST(N'2025-12-08T20:48:53.717' AS DateTime), 3, NULL, 0, CAST(N'2025-12-12T10:36:58.317' AS DateTime), 3, 150000)
...
Nó không nương bàn tay tấn công bình đẳng ấy với bất kỳ ai, kể cả tôi - người có một thân thể khỏe mạnh, hay cô ấy - người sắp ra đi vì căn bệnh nan y.”', N'<table class="table table-bordered">
									...
									</table>', N'to-muon-an-tuy-cua-cau-1.jpg', N'to-muon-an-tuy-cua-cau-2.jpg', N'to-muon-an-tuy-cua-cau-3.jpg', N'to-muon-an-tuy-cua-cau-4.jpg', N'to-muon-an-tuy-cua-cau-5.jpg', 1, 1, 7, N'to-muon-an-tuy-cua-cau', CAST(N'2025-12-08T21:03:29.600' AS DateTime), 3, NULL, 0, NULL, 0, 0)
...
Nhắm mắt lại, Saki  đưa tay vào túi, vừa nắm chặt mảnh kim loại trong tay vừa lặp lại lời cầu nguyện mong Takeru bình an vô sự.', N'<table class="table table-bordered">
									...
									</table>', N'toi-yeu-em-qua-hinh-hai-robot-1.jpg', N'toi-yeu-em-qua-hinh-hai-robot-2.jpg', N'toi-yeu-em-qua-hinh-hai-robot-3.jpg', N'toi-yeu-em-qua-hinh-hai-robot-4.jpg', N'toi-yeu-em-qua-hinh-hai-robot-5.jpg', 1, 5, 7, N'toi-yeu-em-qua-hinh-hai-robot', CAST(N'2025-12-08T21:12:36.300' AS DateTime), 3, NULL, 0, NULL, 0, 0)
...
Trong suốt chuyến đi này, những lời nói dối, sự ganh tị, hối hận cùng tình cảm hướng đến Keita dần được hé lộ. Và rồi, kết cục ngoài dự đoán cũng xuất hiện ở phía cuối hành trình.', N'<table class="table table-bordered">
									...
									</table>', N'thang-9-da-toi-1.jpg', N'thang-9-da-toi-2.jpg', N'thang-9-da-toi-3.jpg', N'thang-9-da-toi-4.jpg', N'thang-9-da-toi-5.jpg', 1, 2, 7, N'va-roi-thang-9-da-toi', CAST(N'2025-12-08T21:27:47.457' AS DateTime), 3, NULL, 0, CAST(N'2025-12-08T21:29:01.380' AS DateTime), 3, 0)
...
Nghĩ nhiều, làm nhiều, nói ít… Mấy năm thân thiết của hai cậu được ghi dấu bằng những lúc âm thầm đứng cạnh nhau trên sân ga đợi tàu đi học, âm thầm cùng chế tác chiếc máy bay chở ước vọng tương lai, âm thầm sẻ chia những tật xấu phải che mắt người ngoài, âm thầm cảm nhận nét đẹp của một cô gái, và âm thầm cả khi phát hiện ra nhau lại tiếp tục chung sở thích về một người.', N'<table class="table table-bordered">
									...
									</table>', N'ben-kia-may-troi-1.jpg', N'ben-kia-may-troi-2.jpg', N'ben-kia-may-troi-3.jpg', N'ben-kia-may-troi-4.jpg', N'ben-kia-may-troi-5.jpg', 1, 2, 7, N'ben-kia-may-troi-la-noi-hen-uoc', CAST(N'2025-12-08T21:39:34.743' AS DateTime), 3, NULL, 0, CAST(N'2025-12-12T10:55:59.163' AS DateTime), 3, 140000)
...
Đáng chú ý trong tập này: Rốt cuộc đã xảy ra chuyện gì mà đến cả thầy giáo thể dục Tomioka – vốn lạnh lùng hơn băng giá – cũng phải rớt nước mắt!? Tất cả sẽ được làm sáng tỏ qua phần ngoại truyện “Học viện Diệt quỷ”.', N'<table class="table table-bordered">
									...
									</table>', N'diet-quy-2-canh-buom-khuyet-1.jpg', N'diet-quy-2-canh-buom-khuyet-2.jpg', N'diet-quy-2-canh-buom-khuyet-3.jpg', N'diet-quy-2-canh-buom-khuyet-2.jpg', N'diet-quy-2-canh-buom-khuyet-3.jpg', 1, 1, 7, N'diet-quy-canh-buom-khuyet', CAST(N'2025-12-20T05:52:41.777' AS DateTime), 3, NULL, 0, NULL, 0, 50000)
INSERT [dbo].[Products] ([Id], [Code], [Name], [Price], [Quality], [Views], [Description], [Specification], [Image1], [Image2], [Image3], [Image4], [Image5], [Active], [Manu_Id], [Cate_Id], [NameSearch], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate], [Sales]) VALUES (30, N'SEVENDAYTB', N'Seven Days (Tái Bản)', 64000, 11, 2, N'Câu chuyện khởi đầu bằng cuộc gặp gỡ giữa cậu nam sinh năm ba cao trung Shino Yuzuru và người đàn em câu lạc bộ bắn cung Seryo Toji tại cổng trường vào một buổi sáng thứ Hai. Seryo là anh chàng được nữ sinh trong trường vô cùng mến mộ bất kể mọi khối lớp, nổi tiếng với tin đồn nhất định sẽ hẹn hò cùng người tỏ tình đầu tiên hôm thứ Hai, nhưng chia tay ngay lúc cuối tuần. Thời hạn một tuần để làm người yêu của nhau… Chỉ bằng câu nói buột ra trong phút nông nổi của Yuzuru, đã kéo cả hai vào bảy ngày vờ như hò hẹn, vậy nhưng…', N'<table class="table table-bordered">
									...
									</table>', N'seven-day-1.jpg', N'seven-day-2.jpg', N'seven-day-3.jpg', N'seven-day-2.jpg', N'seven-day-3.jpg', 1, 1, 7, N'seven-days-tai-ban', CAST(N'2025-12-20T06:02:35.700' AS DateTime), 3, NULL, 0, NULL, 0, 80000)
...
Khi tất cả mọi hiểu lầm được hóa giải, tất cả mọi hoài nghi được tan biến, anh đứng trước mặt cô với một thân phận hoàn toàn mới, còn cô phải làm thế nào để vượt qua được tòa thành tình cảm chất chứa 10 năm đây?', N'<table class="table table-bordered">
									...
									</table>', N'noi-nho-anh-hoa-thanh-toa-thanh-1.jpg', N'noi-nho-anh-hoa-thanh-toa-thanh-2.png', N'noi-nho-anh-hoa-thanh-toa-thanh-3.png', N'noi-nho-anh-hoa-thanh-toa-thanh-3.png', N'noi-nho-anh-hoa-thanh-toa-thanh-2.png', 1, 1, 7, N'noi-nho-anh-hoa-thanh-toa-thanh-tron-bo', CAST(N'2025-12-20T06:10:58.087' AS DateTime), 3, NULL, 0, NULL, 0, 258000)
...
Và liệu ba Loài người được tha thứ kia có gây nên những sóng gió gì không?', N'<table class="table table-bordered">
									...
									</table>', N'nguyet-dao-di-gioi-tap3-1.jpg', N'nguyet-dao-di-gioi-tap3-2.jpg', N'nguyet-dao-di-gioi-tap3-3.jpg', N'nguyet-dao-di-gioi-tap3-4.jpg', N'nguyet-dao-di-gioi-tap3-5.jpg', 1, 7, 7, N'nguyet-dao-di-gioi-dac-biet-tap-3', CAST(N'2025-12-20T06:24:28.580' AS DateTime), 3, NULL, 0, NULL, 0, 129000)
INSERT [dbo].[Products] ([Id], [Code], [Name], [Price], [Quality], [Views], [Description], [Specification], [Image1], [Image2], [Image3], [Image4], [Image5], [Active], [Manu_Id], [Cate_Id], [NameSearch], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate], [Sales]) VALUES (33, N'HPTB7C', N'Harry Potter Hộp (Trọn Bộ 7 Cuốn)', 1271000, 9, 2, N'Harry Potter là tên của bộ truyện (gồm bảy phần) của nữ nhà văn J. K. Rowling viết về cậu bé thiếu niên Harry Potter. Câu chuyện phần lớn diễn ra tại Trường Phù thủy và Pháp sư Hogwarts, một ngôi trường pháp thuật, và tập trung vào cuộc chiến của Harry Potter chống lại một phù thủy hắc ám là Chúa tể Voldemort, người đã giết cha mẹ cậu trong tham vọng làm chủ thế giới phù thủy.', N'<table class="table table-bordered">
									...
									</table>', N'harry-potter-tron-bo-7-cuon-1.jpg', N'harry-potter-tron-bo-7-cuon-2.jpg', N'harry-potter-tron-bo-7-cuon-3.jpg', N'harry-potter-tron-bo-7-cuon-4.jpg', N'harry-potter-tron-bo-7-cuon-5.jpg', 1, 2, 7, N'harry-potter-tron-bo-7-cuon', CAST(N'2025-12-20T06:34:03.080' AS DateTime), 3, NULL, 0, NULL, 0, 1550000)
...
“Người ta nói rằng vì sao sáng nhất trên bầu trời chính là người vô cùng quan trọng đối với mình. Khi một ai đó mất đi, họ sẽ hóa thành ngôi sao và tiếp tục tỏa sáng. Sau khi tớ không còn nữa, mỗi khi Kou tình cờ ngước nhìn bầu trời đêm, hy vọng tớ sẽ là ngôi sao sáng nhất ở đó.”', N'<table class="table table-bordered">
									...
									</table>', N'doi-ban-tay-siet-chac-1.jpg', N'doi-ban-tay-siet-chac-2.jpg', N'doi-ban-tay-siet-chac-3.jpg', N'doi-ban-tay-siet-chac-4.jpg', N'doi-ban-tay-siet-chac-3.jpg', 1, 2, 7, N'doi-ban-tay-siet-chac', CAST(N'2025-12-20T06:40:48.903' AS DateTime), 3, NULL, 0, NULL, 0, 0)
...
“Nhưng nhà luyện kim đan không quan tâm mấy đến những điều ấy. Ông đã từng thấy nhiều người đến rồi đi, trong khi ốc đảo và sa mạc vẫn là ốc đảo và sa mạc. Ông đã thấy vua chúa và kẻ ăn xin đi qua biển cát này, cái biển cát thường xuyên thay hình đổi dạng vì gió thổi nhưng vẫn mãi mãi là biển cát mà ông đã biết từ thuở nhỏ. Tuy vậy, tự đáy lòng mình, ông không thể không cảm thấy vui trước hạnh phúc của mỗi người lữ khách, sau bao ngày chỉ có cát vàng với trời xanh nay được thấy chà là xanh tươi hiện ra trước mắt. ‘Có thể Thượng đế tạo ra sa mạc chỉ để cho con người biết quý trọng cây chà là,’ ông nghĩ.”', N'<table class="table table-bordered">
									...
									</table>', N'nha-gia-kim-1.jpg', N'nha-gia-kim-1.jpg', N'nha-gia-kim-3.jpg', N'nha-gia-kim-4.jpg', N'nha-gia-kim-3.jpg', 1, 10, 5, N'nha-gia-kim', CAST(N'2025-12-20T08:04:09.950' AS DateTime), 3, NULL, 0, NULL, 0, 79000)
...
Khoảnh khắc khó chịu nhất có lẽ là khi mình đã lỡ chọn một hướng đi, nhưng ngộ được rằng con đường này nhiều chông gai, lắm rào cản và lại còn không phù hợp. Trong lòng, lúc ấy chỉ muốn được quay trở lại để bắt đầu, để lựa chọn lại một hướng khôn ngoan hơn.', N'<table class="table table-bordered">
									...
									</table>', N'moi-doi-ke-tim-duong-1.jpg', N'moi-doi-ke-tim-duong-2.jpg', N'moi-doi-ke-tim-duong-3.jpg', N'khu-vuon-ngon-tu-4.jpg', N'moi-doi-ke-tim-duong-5.jpg', 1, 7, 5, N'mot-doi-ke-tim-duong', CAST(N'2025-12-20T21:55:50.917' AS DateTime), 3, NULL, 0, NULL, 0, 0)
INSERT [dbo].[Products] ([Id], [Code], [Name], [Price], [Quality], [Views], [Description], [Specification], [Image1], [Image2], [Image3], [Image4], [Image5], [Active], [Manu_Id], [Cate_Id], [NameSearch], [CreateDay], [PersonCreate], [DeleteDay], [PersonDelete], [UpdateDay], [PersonUpdate], [Sales]) VALUES (40, N'RLTDPB01', N'Rèn Luyện Tư Duy Phản Biện', 80000, 27, 1, N'Như bạn có thể thấy, chìa khóa để trở thành một người có tư duy phản biện tốt chính là sự tự nhận thức. Bạn cần phải đánh giá trung thực những điều trước đây bạn nghĩ là đúng, cũng như quá trình suy nghĩ đã dẫn bạn tới những kết luận đó. Nếu bạn không có những lý lẽ hợp lý, hoặc nếu suy nghĩ của bạn bị ảnh hưởng bởi những kinh nghiệm và cảm xúc, thì lúc đó hãy cân nhắc sử dụng tư duy phản biện! Bạn cần phải nhận ra được rằng con người, kể từ khi sinh ra, rất giỏi việc đưa ra những lý do lý giải cho những suy nghĩ khiếm khuyết của mình. Nếu bạn đang có những kết luận sai lệch này thì có một sự thật là những đức tin của bạn thường mâu thuẫn với nhau và đó thường là kết quả của thiên kiến xác nhận, nhưng nếu bạn biết điều này, thì bạn đã tiến gần hơn tới sự thật rồi!', N'<table class="table table-bordered">
									...
									</table>', N'ren-luyen-tu-duy-phan-bien.jpg', N'ren-luyen-tu-duy-phan-bien-2.jpg', N'ren-luyen-tu-duy-phan-bien-3.jpg', N'ren-luyen-tu-duy-phan-bien-2.jpg', N'ren-luyen-tu-duy-phan-bien-3.jpg', 1, 1, 5, N'ren-luyen-tu-duy-phan-bien', CAST(N'2025-12-20T22:01:51.123' AS DateTime), 3, NULL, 0, NULL, 0, 0)
